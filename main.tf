...
module "eks" {
  ...
  eks_otel_gateway_enabled        = var.eks_otel_gateway_enabled
  eks_otel_gateway_replica_count  = var.eks_otel_gateway_replica_count
  eks_otel_gateway_cpu_request    = var.eks_otel_gateway_cpu_request
